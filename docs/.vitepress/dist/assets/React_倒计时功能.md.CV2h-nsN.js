import{_ as n,c as s,o as a,V as p}from"./chunks/framework.DIPPIwJv.js";const g=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"React/倒计时功能.md","filePath":"React/倒计时功能.md"}'),e={name:"React/倒计时功能.md"},l=p(`<h3 id="实现一个倒计时抢券组件-页面加载时从-10s-开始倒计时-倒计时结束之后点击按钮请求接口进行抢券-同时更新文案" tabindex="-1">实现一个倒计时抢券组件，页面加载时从 10s 开始倒计时，倒计时结束之后点击按钮请求接口进行抢券，同时更新文案 <a class="header-anchor" href="#实现一个倒计时抢券组件-页面加载时从-10s-开始倒计时-倒计时结束之后点击按钮请求接口进行抢券-同时更新文案" aria-label="Permalink to &quot;实现一个倒计时抢券组件，页面加载时从 10s 开始倒计时，倒计时结束之后点击按钮请求接口进行抢券，同时更新文案&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>import { useEffect, useState } from &quot;react&quot;</span></span>
